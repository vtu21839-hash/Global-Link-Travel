...
class _HeritageSitesScreenState extends State<HeritageSitesScreen> {
  ...
  final List<Map<String, dynamic>> _heritageSites = [
    ...
    },
    {
      ...
      'type': 'Temple',
      'image': 'https://images.unsplash.com/photo-1618939291225-8d558ea71a3f?w=600',
    ...
    },
    {
      ...
      'description': 'UNESCO World Heritage Site built by Raja Raja Chola I. Features one of the tallest temple towers in India at 66 meters.',
      'timing': '6:00 AM - 12:30 PM, 4:00 PM - 8:30 PM',
      'entryFee': 30,
      'rating': 4.8,
      'bestTime': 'Oct - Mar',
      'tips': ['Amazing shadow play at noon', 'Night illumination is beautiful', 'Largest monolithic Nandi statue'],
    },
    // Kingdoms/Forts
    {
      'name': 'Taj Mahal',
